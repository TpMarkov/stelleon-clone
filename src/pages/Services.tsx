...
const ServicesGrid = () => {
  const services = [
    ...
    { icon: Code, title: 'Custom Software', description: 'We help SMEs build custom software to gain a competitive edge and deliver unique solutions.', href: '/services' },
    { icon: Globe, title: 'SaaS', description: 'We handle all SaaS development, delivering reliable solutions for business growth and innovation.', href: '/services' },
